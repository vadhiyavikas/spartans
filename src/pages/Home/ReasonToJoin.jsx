    ...
    <div className="text-white py-10 lg:py-16">
      ...
      <div className="grid md:grid-cols-2 gap-10 mt-10 lg:mt-20">
        <div className="flex gap-3">
          <img src="\assets\images\icon_line.png" alt="scale-logo" className="min-w-[56px]"/>
        ...
        <div className="flex gap-3">
          <img src="\assets\images\icon_ eqipment.png" alt="dumb-logo" className="max-w-[56px]"/>
          <div className="flex flex-col gap-2">
        ...
        <div className="flex gap-3">
          <img src="\assets\images\icon_ fitness zones.png" alt="equ-logo" />
          <div className="flex flex-col gap-2">
        ...
        <div className="flex gap-3">
          <img src="\assets\images\icon_time.png" alt="clock-logo" />
          <div className="flex flex-col gap-2">
